...
import { ALL_ITEMS, BUFFER_LIMIT, BUILDINGS, BuildingType, CHUNK_SIZE, Direction, DIRECTIONS, MAP_RADIUS_CHUNKS, RECIPES, SELLABLE_IDS, TICK_MS, AnyItemId, Recipe, chunkPrice, oresForChunk, plantsForChunk } from "./game-data";
